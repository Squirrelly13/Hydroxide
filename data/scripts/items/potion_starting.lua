...
function init( entity_id ) --mostly vanilla function
	...
	--ps.TEST(100000000) --1 billion took about 45 minutes for me to build so 100k-10mil should be good enough for regular tests (probs still super excessive tbh lmao)
