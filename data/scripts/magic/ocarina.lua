...
local ocarina_songs = { 
	...
	tinker = { "a2", "f", "d", "b", "a", "c", "e", "gsharp", "a2"},
}
				...
				for i,comp in ipairs(variables) do
					...
					if ( name == "ocarina_song_pos" ) then
						...
						if ( #b > 0 ) then
							...
							print( "currsong: " .. tostring(currsong) )
							print( "note position: " .. tostring(current_note_pos) )
							...
							elseif ( current_note_pos == song_length ) and ( note == current_note ) then
								...
								elseif ( currsong == "tinker" ) then
									do_tinker_magic = true
								end
