...
local CC = {
	...
	{ origin = "CC", probability = 0.0500, "cc_devouring_moss" },
	{ origin = "CC", probability = 0.0400, "cc_metamorphine" },
	{ origin = "CC", probability = 0.0250, "cc_antimatter_powder" },
	{ origin = "CC", probability = 0.0080, "cc_health_tonic" },
...
local AA = 	{
	...
	{ origin = "AA", probability = 0.0500, "aa_chaotic_pandorium" },
