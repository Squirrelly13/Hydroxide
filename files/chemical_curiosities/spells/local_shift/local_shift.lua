...
organic =	{ probability = 0.5, name = "organics", materials = { "blood", "blood_fungi", "blood_cold", "blood_worm", "AA_hungry_slime", "AA_hungry_slime_growing","devouringMoss", "iron_ingredient", "meat", "rotten_meat", "frozen_meat", "rice" }}
potions =	{ probability = 0.3, name = "potions", materials = { "ferrineSkin", "magic_liquid_polymorph", "magic_liquid_unstable_polymorph", "magic_liquid_berserk", "magic_liquid_charm", "magic_liquid_invisibility","sparkLiquid", "sliceLiquid", "glitteringLiquid", "CC_potionBlindness", "magic_liquid_movement_slower", "AA_icy_inferno", "magic_liquid_slower_levitation", "magic_liquid_slower_levitation_and_movement", "explodePlayer", "AA_arborium", "AA_love", "AA_repultium", "AA_base_potion", "AA_cloning_solution", "AA_condensed_gravity", "AA_pop_rocks", "AA_meager_offering", "rice" }}
...
gas		=	{ probability = 0.8, name = "gasses", materials = { "acid_gas", "acid_gas_static", "poison_gas", "fungal_gas", "radioactive_gas", "radioactive_gas_static", "steam", "smoke", "AA_potion_gas","methane", "hydroxide_gas", "cloud" }}
