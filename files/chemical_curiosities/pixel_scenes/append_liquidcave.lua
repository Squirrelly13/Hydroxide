...
table.insert(g_pixel_scene_01, {
	...
	background_file	= "",
	is_unique		= 0,
	color_material = { ["fff0bbee"] = {"aa_hitself", "aa_darkmatter", "aa_static_charge", "aa_repultium", "aa_creeping_slime", "aa_love", "aa_condensed_gravity", "aa_cloning_solution", "cc_jitterium", "cc_unstable_metamorphine", "cc_nullium", } }
});
