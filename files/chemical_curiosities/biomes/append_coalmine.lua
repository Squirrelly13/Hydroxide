...
table.insert(g_pixel_scene_01, {
	prob			= 0.9,
	material_file	= "mods/Hydroxide/files/chemical_curiosities/biomes/coalmine/shrinekindling.png",
	visual_file		= "mods/Hydroxide/files/chemical_curiosities/biomes/coalmine/shrinekindling_visual.png",
	background_file	= "",
	is_unique		= 0
	});
...
table.insert(g_pixel_scene_02, {--TODO change 0.9 to lower numebr if this works
	prob			= 0.9,
	material_file	= "mods/Hydroxide/files/chemical_curiosities/biomes/coalmine/moss_pit.png",
	visual_file		= "mods/Hydroxide/files/chemical_curiosities/biomes/coalmine/moss_pit_visual.png",
	background_file	= "mods/Hydroxide/files/chemical_curiosities/biomes/coalmine/moss_pit_background.png",
	is_unique		= 0
	});
