...
table.insert(status_effects, {
	...
	effect_entity="mods/Hydroxide/files/chemical_curiosities/materials/potionBlindness/effect_blindness.xml",
	protects_from_fire=false,
 	is_harmful=true,
});
...
table.insert(status_effects, {
	...
	effect_entity="mods/Hydroxide/files/chemical_curiosities/materials/potionTwitchy/effect_twitchy.xml",
	is_harmful=true,
});
...
table.insert(status_effects, {
	...
	ui_icon="mods/Hydroxide/files/chemical_curiosities/materials/potionSlowness/effect_levitation_slow.png",
	effect_entity="mods/Hydroxide/files/chemical_curiosities/materials/potionSlowness/effect_slower_levitation.xml",
	is_harmful=true,
});
...
table.insert(status_effects, {
	...
	effect_entity="mods/Hydroxide/files/chemical_curiosities/materials/explodePlayer/effect_explosion.xml",
	is_harmful=true,
...
table.insert(status_effects, {
	...
	ui_icon="mods/Hydroxide/files/chemical_curiosities/materials/tinkerDust/effect_tinker.png",
	effect_entity="mods/Hydroxide/files/chemical_curiosities/materials/tinkerDust/effect_tinker.xml",
	is_harmful=false,
});
...
table.insert(status_effects, {
	...
	ui_icon="mods/Hydroxide/files/chemical_curiosities/materials/increaseMaxHP/effect_increasehp.png",
	effect_entity="mods/Hydroxide/files/chemical_curiosities/materials/increaseMaxHP/effect_increasehp.xml",
	is_harmful=false,
});
...
table.insert(status_effects, {
	...
	ui_icon="mods/Hydroxide/files/chemical_curiosities/materials/metalStuff/effect_ironskin.png",
	effect_entity="mods/Hydroxide/files/chemical_curiosities/materials/metalStuff/effect_ironskin.xml",
	is_harmful=false,
});